  ...
  `}</style>
      <table width="60%">
        ...
        <tbody>
          ...
          {origin.undercarriage?.axle_weight_front_unload !== values.undercarriage?.axle_weight_front_unload && (
            <tr>
              <td>공차 하중 (1축)</td>
          ...
          {origin.undercarriage?.axle_weight_rear_unload !== values.undercarriage?.axle_weight_rear_unload && (
            <tr>
              <td>공차 하중 (2축)</td>
          ...
          {origin.undercarriage?.axle_weight_front_load !== values.undercarriage?.axle_weight_front_load && (
            <tr>
              <td>적재 하중 (1축)</td>
          ...
          {origin.undercarriage?.axle_weight_rear_load !== values.undercarriage?.axle_weight_rear_load && (
            <tr>
              <td>적재 하중 (2축)</td>
